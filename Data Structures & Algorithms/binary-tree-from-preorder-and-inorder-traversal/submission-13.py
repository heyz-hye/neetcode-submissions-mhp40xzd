...
class Solution:
    def buildTree(self, preorder: List[int], inorder: List[int]) -> Optional[TreeNode]:
        ...
        def left2right(left, right)->TreeNode:
            ...
            self.preorderindex+=1 #need to move pointer since we are not slicing any
                                  #any array we keep our original array.
                                  #need to increment the index pointer since 0 is always
                                  #pointing the the root of the entire tree
