...
we can loop through key or value because value is a TrieNode, if we want to use key we just have to set node equal to node.children[key] aka the key's correspondent TrieNode
